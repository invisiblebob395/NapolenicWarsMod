...
itp_is_carriage              = 0x0080000000000000 # For horses, Disables them from being able to jump.
...
itc_dagger_no_stab  = itc_cleaver
...
#itc_cutting_spear = itc_spear| itcf_overswing_spear
