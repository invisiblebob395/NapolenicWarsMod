...
# first client > server events

# non admin ones.
multiplayer_event_set_item_selection                          = 0
multiplayer_event_change_team_no                              = 1
multiplayer_event_change_troop_id                             = 2
multiplayer_event_send_control_command                        = 3
multiplayer_event_send_player_action                          = 4
multiplayer_event_player_build_prop                           = 5
multiplayer_event_start_new_poll                              = 6
multiplayer_event_answer_to_poll                              = 7
multiplayer_event_open_game_rules                             = 8
multiplayer_event_offer_duel                                  = 9
multiplayer_event_set_spawn_flag                              = 10
#custom_chat: client->server msg
multiplayer_event_send_custom_chat                            = 11
multiplayer_event_start_new_custom_poll                       = 12

# admin events.
multiplayer_event_open_admin_panel                            = 13
multiplayer_event_admin_start_map                             = 14
multiplayer_event_admin_set_num_bots_in_team                  = 15
multiplayer_event_admin_set_friendly_fire                     = 16
multiplayer_event_admin_set_melee_friendly_fire               = 17
multiplayer_event_admin_set_friendly_fire_damage_self_ratio   = 18
multiplayer_event_admin_set_friendly_fire_damage_friend_ratio = 19
multiplayer_event_admin_set_ghost_mode                        = 20
multiplayer_event_admin_set_control_block_dir                 = 21
multiplayer_event_admin_set_respawn_period                    = 22
multiplayer_event_admin_set_game_max_minutes                  = 23
multiplayer_event_admin_set_round_max_seconds                 = 24
multiplayer_event_admin_set_game_max_points                   = 25
multiplayer_event_admin_set_point_gained_from_flags           = 26
multiplayer_event_admin_set_point_gained_from_capturing_flag  = 27
multiplayer_event_admin_set_server_name                       = 28
multiplayer_event_admin_set_game_password                     = 29
multiplayer_event_admin_set_team_faction                      = 30
multiplayer_event_admin_set_num_bots_voteable                 = 31
multiplayer_event_admin_set_factions_voteable                 = 32
multiplayer_event_admin_set_maps_voteable                     = 33
multiplayer_event_admin_set_player_respawn_as_bot             = 34
multiplayer_event_admin_set_combat_speed                      = 35
multiplayer_event_admin_set_respawn_count                     = 36
multiplayer_event_admin_set_kick_voteable                     = 37
multiplayer_event_admin_set_ban_voteable                      = 38
multiplayer_event_admin_set_valid_vote_ratio                  = 39
multiplayer_event_admin_set_auto_team_balance_limit           = 40
multiplayer_event_admin_set_welcome_message                   = 41
multiplayer_event_admin_set_allow_player_banners              = 42
multiplayer_event_admin_kick_player                           = 43
multiplayer_event_admin_ban_player                            = 44
multiplayer_event_admin_cheat_spawn_item                      = 45
multiplayer_event_admin_cheat_teleport                        = 46
multiplayer_event_admin_set_mod_variable                      = 47
multiplayer_event_send_admin_chat                             = 48
multiplayer_event_send_inter_admin_chat                       = 49
multiplayer_event_player_list_action                          = 50
multiplayer_event_reset_map                                   = 51
# Vincenzo

#server events
multiplayer_event_return_num_bots_in_team                     = 52
multiplayer_event_return_friendly_fire                        = 53
multiplayer_event_return_ghost_mode                           = 54
multiplayer_event_return_control_block_dir                    = 55
multiplayer_event_return_combat_speed                         = 56
...
multiplayer_event_return_respawn_count                        = 87
multiplayer_event_return_player_respawn_spent                 = 88
multiplayer_event_return_kick_voteable                        = 89
multiplayer_event_return_ban_voteable                         = 90
multiplayer_event_return_valid_vote_ratio                     = 91
multiplayer_event_return_auto_team_balance_limit              = 92
multiplayer_event_return_renaming_server_allowed              = 93
multiplayer_event_return_changing_game_type_allowed           = 94
multiplayer_event_return_melee_friendly_fire                  = 95
multiplayer_event_return_friendly_fire_damage_self_ratio      = 96
multiplayer_event_return_friendly_fire_damage_friend_ratio    = 97
multiplayer_event_return_allow_player_banners                 = 98
multiplayer_event_return_open_game_rules                      = 99
multiplayer_event_return_max_num_bots                         = 100
multiplayer_event_return_server_mission_timer_while_player_joined = 101
multiplayer_event_show_duel_request                           = 102
multiplayer_event_start_duel                                  = 103
multiplayer_event_cancel_duel                                 = 104
multiplayer_event_show_server_message                         = 105
multiplayer_event_return_agent_stop_sound                     = 106
multiplayer_event_return_mod_variable                         = 107
multiplayer_event_return_admin_chat                           = 108
multiplayer_event_return_inter_admin_chat                     = 109
multiplayer_event_return_sound_at_pos                         = 110
multiplayer_event_return_particle_at_pos                      = 111
multiplayer_event_return_scale_object                         = 112
multiplayer_event_return_currently_controlling_object         = 113
multiplayer_event_return_build_points                         = 114
multiplayer_event_return_prop_effects                         = 115
multiplayer_event_return_thunder                              = 116
multiplayer_event_return_server_action                        = 117
multiplayer_event_return_before_round_end                     = 118
multiplayer_event_return_destructible_prop_spawn_or_destroy   = 119
multiplayer_event_return_cannon_hit_effect_event              = 120
multiplayer_event_return_agent_set_item                       = 121
multiplayer_event_return_on_agent_hit                         = 122
multiplayer_event_return_current_scene						            = 123  #PATCh1115 15/5  
multiplayer_event_ask_for_custom_poll                         = 124
#modder_props:
multiplayer_event_return_custom_string                        = 125 #string assigned to troop
# 127 is max!,  2 left to use.
...
multiplayer_message_type_attackers_won_the_round     = 15
multiplayer_message_type_start_death_mode            = 16
multiplayer_message_type_error                       = 17
multiplayer_message_type_warning                     = 18
multiplayer_message_type_message                     = 19
multiplayer_message_type_admin                       = 20
multiplayer_message_type_message_custom_color        = 21 #custom_color:
multiplayer_message_type_show_custom_order_menu      = 22

multiplayer_message_types_begin                      = multiplayer_message_type_auto_team_balance_done
multiplayer_message_types_end                        = 23
...
multiplayer_game_type_capture_the_flag       = 3
multiplayer_game_type_headquarters           = 4
multiplayer_game_type_siege                  = 5
multiplayer_game_type_duel                   = 6
multiplayer_game_type_commander              = 7
multiplayer_game_type_king	                 = 8
multiplayer_game_type_scene_making           = 9
multiplayer_num_game_types                   = 10
multiplayer_game_type_royale                 = 11

#admin panel value ranges
multiplayer_round_max_seconds_min            = 60
multiplayer_round_max_seconds_max            = 3601
multiplayer_respawn_period_min               = 3
multiplayer_respawn_period_max               = 121 #can only be 30 seconds max (due to agent deletion after that period)
...
multiplayer_new_agents_finish_spawning_time = 33
...
multi_data_maps_for_game_type_end = multi_data_maps_for_game_type_begin + 100
...
#Beaver
multi_data_troop_display_indices_begin = multi_data_troop_button_indices_end
multi_data_troop_display_indices_end = multi_data_troop_display_indices_begin + 16 #maximum 16 troops per faction

multi_data_item_button_indices_begin = multi_data_troop_display_indices_end
...
#Beaver
multi_data_flag_original_owner_begin = multi_data_flag_owner_end
multi_data_flag_original_owner_end = multi_data_flag_original_owner_begin + 10 #maximum of 10 flags per scene

multi_data_flag_players_around_begin = multi_data_flag_original_owner_end 
...
multi_entry_points_for_usable_items_end = multi_entry_points_for_usable_items_start + 20
...
multi_troop_class_mm_rifle = 13
multi_troop_class_mm_cavalry = 14
multi_troop_class_mm_lancer = 15
multi_troop_class_mm_hussar = 16
multi_troop_class_mm_dragoon = 17
multi_troop_class_mm_cuirassier = 18
multi_troop_class_mm_heavycav = 19
multi_troop_class_mm_artillery = 20
multi_troop_class_mm_rocket = 21
multi_troop_class_mm_sapper = 22
multi_troop_class_mm_surgeon = 23 #patch1115 59/14
...
multi_headquarters_max_distance_sq_to_raise_flags = 3600 #6m * 6m * 100 = 1600
multi_headquarters_distance_sq_to_set_flag = 8100 #9m * 9m * 100 = 8100 
multi_headquarters_distance_sq_to_change_flag = 1600 #4m * 4m * 100 = 1600 
multi_headquarters_distance_to_change_flag = 400 #4m * 100 =400 
