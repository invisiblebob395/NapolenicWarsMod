...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 ["jump", acf_enforce_all, amf_priority_jump|amf_play|amf_client_prediction|amf_continue_to_next,
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   [1.0, "jump", 22, 46, arf_blend_in_1],
##   [0.8, "anim_human", 270, 272, arf_blend_in_4],
 ],
 ["jump_loop", acf_enforce_all, amf_priority_jump|amf_play|amf_client_prediction,
##   [0.8, "jump_loop", 0, 30, arf_blend_in_2|arf_cyclic],
   [0.5, "jump_loop", 0, 14, arf_blend_in_3|arf_cyclic],
 ],
 ["jump_end", acf_enforce_all, amf_priority_jump_end|amf_play|amf_client_prediction,
##   [0.1, "jump", 48, 55, arf_blend_in_1],
   [0.3, "jump", 48, 55, arf_blend_in_2],
 ],
 ["jump_end_hard", acf_enforce_all, amf_priority_jump_end|amf_play|amf_client_prediction,
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
   [0.6, "jump_end_hard", 36, 54, arf_blend_in_1],
 ],
 ["stand_unarmed", 0, amf_client_prediction,
   [8, "french_officer", 0, 148, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_single", 0, amf_client_prediction,
   [6.0, "general_officer_idle", 0, 74, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["stand_staff", 0, amf_client_prediction,
   [4.0, "staff_cstance_musket", 0, 59, arf_use_stand_progress|arf_cyclic|arf_blend_in_16, 0, (0, 0, 0), 0.0],  
 ],
...
##   [0.8, "run_crossright_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_forward_right_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "AoN_run_forward_right_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
  # [0.8, "run_forward_right_musket", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_crossleft_onehanded", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_forward_left_staff", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "AoN_run_forward_left_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   #[0.8, "run_forward_left_musket", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   #[1.0, "bajonet_walk", 30, 0, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "AoN_run_backward_staff", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "AoN_run_backward_staff_right", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "AoN_run_backward_staff_left", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [0.8, "run_right_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   ...
   [0.8, "AoN_run_right_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
 ],
...
##   [0.8, "run_left_staff", 0, 24, arf_use_walk_progress|arf_cyclic|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],  
   [0.8, "AoN_run_left_staff", 0, 24, arf_use_walk_progress|arf_cyclic|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],  
 ],
...
# duration and controlled via weapon speed.
 ...
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   #[3.0, "musket_reload", 0, 320, arf_blend_in_8|arf_make_custom_sound, pack2f(0.10, 1.00)], #pack2f(0.40, 0.94)], 
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol|amf_use_weapon_speed,
   [0.3, "anim_human", combat+2500, combat+2515, arf_blend_in_8],
 ],
 ["release_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol|amf_use_weapon_speed,
   [0.3, "anim_human", combat+2520, combat+2527, arf_blend_in_1],
 ],
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [2.0, "anim_human", combat+2650, combat+2860, arf_blend_in_8|arf_make_custom_sound, pack2f(0.01, 1.00)],   
 ],
...
#   [1.5, "anim_human", combat+1300, combat+1320, blend_in_ready],
 ...
 ["release_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow|amf_use_weapon_speed,
   [0.2, "anim_human", combat+1330, combat+1331, arf_blend_in_1],
 ],
 ["reload_musket", acf_enforce_lowerbody, amf_priority_reload|amf_use_weapon_speed|amf_play,
  # [3.0, "musket_reload", 0, 320, arf_blend_in_8],
...
##   [ready_durn, "attacks_staff_uptodown", 9, 34, blend_in_ready], 
   [ready_durn, "attacks_staff_uptodown", 9, 26, blend_in_ready],  
##   [ready_durn, "musket_upper_swing", 1, 22, blend_in_ready], 
 ],
...
#   [ready_durn, "thrust_staff", 70, 93, blend_in_ready],
 ...
 ["release_thrust_staff", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
...
#   [0.6, "thrust_staff", 93, 125, arf_blend_in_2], 
 ...
 ["release_thrust_staff_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,# acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
##   [0.6, "anim_human", combat+7334, combat+7340, blend_in_release], 
   [0.3, "attacks_staff_thrust", 40, 58, arf_blend_in_2], 
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.7, "dead_new", 0, 149, arf_blend_in_16|arf_make_custom_sound, pack2f(0.7, 0.0), (0,0,0), 1.8],
   [2.8, "mm_death_1", 0, 60, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.6],
   [1.5, "death_new4", 0, 84, arf_blend_in_16|arf_make_custom_sound, pack2f(0.25, 0.0), (0,0,0), 0.4],
 ],
 ["fall_abdomen_hold_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
  [2.8, "mm_death_2", 0, 54, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.6],
 ],
 ...
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   [2.8, "mm_death_2", 0, 54, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.5],
   [1.2, "death_new5", 0, 103, arf_blend_in_16|arf_make_custom_sound, pack2f(0.3, 0.0), (0,0,0), 0.5],
 ],
...
## ],
 ...
 ["strike_fall_back_rise", acf_enforce_lowerbody|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [2.5, "anim_human", blow+5400, blow+5453, arf_blend_in_2|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 0.5],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["reload_musket_full", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
  [3.0, "man_reload", 0, 340, arf_stick_item_to_left_hand|arf_blend_in_3|arf_make_custom_sound, pack2f(0.10, 1.00)],
 ],
 ["reload_musket_two_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [1.9, "man_reload", 110, 340, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ["reload_musket_one_third", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [0.8, "man_reload", 270, 340, arf_stick_item_to_left_hand|arf_blend_in_3],
 ],
 ...
 ["ready_overswing_spear", acf_thrust|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
	[ready_durn + 0.15, "spear_thrust_overhead", 0, 20, blend_in_ready],
 ],
 ...
 ["parried_overswing_spear", acf_rot_vertical_sword, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration_thrust, "spear_thrust_overhead", 26, 22, arf_blend_in_2],
 ],
 ["blocked_overswing_spear", acf_rot_vertical_sword, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration_thrust, "spear_thrust_overhead", 26, 22, arf_blend_in_2],
 ],
 ...
 ["parried_thrust_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
   [attack_parried_duration, "musket_upper_swing_parry", 1, 9, arf_blend_in_2],
 ],
 ["blocked_thrust_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration, "musket_upper_swing_parry", 1, 9, arf_blend_in_2],
 ],
 ...
 # MM
 #acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
 # ["bagpipe", 0, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
   # [2.0, "bagpipe", 0, 73, arf_blend_in_1],
 # ],
 ["drum", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [1.0, "drum_anim", 0, 89, arf_blend_in_5|arf_cyclic],
  ],
 ["flute", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [1.0, "flute_anim", 0, 29, arf_blend_in_5|arf_cyclic],
  ],
 ["horn", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [3.0, "horn_anim", 0, 74, arf_blend_in_5|arf_cyclic],
  ],
 ["bagpipe", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [5.0, "bagpipe_anim", 0, 89, arf_blend_in_5|arf_cyclic],
  ],
 ["drum_end", 0,amf_play|amf_priority_mount,
    [0.1, "drum_anim", 0, 1, arf_blend_in_5|arf_cyclic],
  ],
 ["piano", acf_enforce_lowerbody,amf_play|amf_keep|amf_priority_mount,
    [4.0, "piano_anim", 0, 119, arf_blend_in_5|arf_cyclic],
  ],
 ["freeze_player", acf_enforce_lowerbody, amf_keep|amf_priority_mount,
   [8, "mm_stupid_sitshitshit", 0, 74, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["shitting", acf_enforce_lowerbody, amf_keep|amf_priority_mount,
   [8, "mm_shitting", 0, 74, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["cannon_load", 0,amf_play|amf_priority_mount,
   [2, "cannon_load", 0, 44, arf_blend_in_5],
 ],
 ["rocket_load", 0,amf_play|amf_priority_mount,
   [4, "rocket_reload_anim", 0, 44, arf_blend_in_5],
 ],
 ["cannon_reload", 0,amf_play|amf_priority_mount,
   [9, "AoN_ram_load_3_times", 0, 72, arf_blend_in_5],
  # [10, "cannon_reload", 0, 58, arf_blend_in_5],
 ],
 ["cannon_fire", 0,amf_play|amf_priority_mount,
   [0.8, "cannon_fire", 0, 32, arf_blend_in_5],
 ],
 ["cannon_end", 0,amf_play|amf_priority_mount,
   [0.1, "cannon_load", 0, 1, arf_blend_in_5],
 ],
 
 ["kneeling", acf_enforce_lowerbody, amf_play|amf_keep|amf_priority_mount,
   [1.3, "crouch_down", 0, 50,  arf_blend_in_1, 0, (0, 0, 0), 0.25],   
 ],
 ["kneeling_end", 0, amf_play|amf_priority_mount,
   [0.1, "crouch_down", 0, 50, arf_blend_in_1],   
 ],
 ["spyglass", 0, amf_play|amf_keep|amf_priority_mount,
   [1.0, "telescope", 22, 44,  arf_blend_in_5],   
 ],
 ["surrender", acf_enforce_all, amf_play|amf_keep|amf_priority_mount,
   [8, "surrender", 0, 148, arf_blend_in_5|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["surrender_end", 0, amf_play|amf_priority_mount,
   [0.1, "surrender", 0, 148, arf_blend_in_5],
 ],
 ["rider_fall_right_2", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body,
   [2.5, "anim_human_02", 350, 382,  arf_blend_in_8, 0, (0.8,-1.8,0), 0.5],
 ],
 ["rider_fall_roll_2", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body,
   [2.5, "anim_human", blow+ 2000, blow+2084,  arf_blend_in_8, 0, (0.0,0.0,0), 1.0],
 ],
 # drinking
 ["drinking_bottle", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_drinking_bottle", 0, 75, arf_blend_in_64|arf_cyclic],
 ],
 ["drinking_tea_idle", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_drinking_tea_idle", 0, 100, arf_blend_in_64|arf_cyclic],
 ],
 ["drinking_tea_loop", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_drinking_tea_loop", 0, 100, arf_blend_in_64|arf_cyclic],
 ],
 ["drinking_cup_idle", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_drinking_cup_idle", 0, 100, arf_blend_in_64|arf_cyclic],
 ],
 ["drinking_cup_loop", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_drinking_cup_loop", 0, 100, arf_blend_in_64|arf_cyclic],
 ],
 # drill cane
 ["cane_idle", 0, amf_play|amf_keep|amf_priority_mount,
   [3.0, "anim_stick_idle", 0, 100, arf_blend_in_0|arf_cyclic],
 ],
 # shtting (uses shitting animation, but does not auto cancle)
 ["sitting", acf_enforce_lowerbody, amf_keep|amf_priority_mount,
   [8, "mm_shitting", 0, 74, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 # ["commander", acf_enforce_all, amf_play|amf_client_owner_prediction,
    # [1.4, "commander", 0, 38, arf_blend_in_1],
 # ],
